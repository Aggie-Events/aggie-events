...
const availableTags = ["Academic", "Arts", "Career", "Cultural", "Recreation", "Service", "Social", "Sports", "Other"];
...
export default function OrgEventsPage() {
  ...
  const { data: events = [], isLoading: eventsLoading } = useEventsByOrg(org?.org_id ?? 0);
  ...
  }, [events, searchQuery, sortField, sortDirection, selectedTags, startDate, endDate]);
